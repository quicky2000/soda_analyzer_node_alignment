...
*/
#ifndef _NODE_ALIGNMENT_ANALYZER_DESCRIPTION_H_
#define _NODE_ALIGNMENT_ANALYZER_DESCRIPTION_H_

#include "analyzer_description_if.h"

namespace osm_diff_analyzer_node_alignment
{
  class node_alignment_analyzer_description: public osm_diff_analyzer_if::analyzer_description_if
  {
  public:
...
#endif // _NODE_ALIGNMENT_ANALYZER_DESCRIPTION_H_
//EOF
